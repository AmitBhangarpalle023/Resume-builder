...
let preview=document.querySelector(".preview-cnt-l");
let color=document.querySelectorAll(".t");
let pbt1=document.querySelector(".ab1");
let pbt2=document.querySelector(".ab2");

let pi=document.querySelector(".ab3");
let pi1=document.querySelector(".ab4");
let pi2=document.querySelector(".ab5");
let pi3=document.querySelector(".ab6");
let pi4=document.querySelectorAll(".preview-item-val");

color.forEach((colr)=>{
    colr.addEventListener("click",()=>{
        let n=colr.getAttribute("id");
        console.log(n);
        if(n=="green"){
            preview.style.backgroundColor="rgb(61, 212, 76)";
        }
        if(n=="beige"){
            preview.style.backgroundColor="rgb(245, 245, 220)";
        }
        if(n=="yellow"){
            preview.style.backgroundColor="rgb(120, 201, 221)";
        }
        if(n=="brown"){
            preview.style.backgroundColor="rgb(208, 87, 87)";
            
        }
        if(n=="grey"){
            preview.style.backgroundColor="rgb(173, 173, 173)";
            
        }
        if(n=="purple"){
            preview.style.backgroundColor="rgb(211, 95, 211)";
